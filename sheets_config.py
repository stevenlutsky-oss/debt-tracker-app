...
# Based on actual header positions in the CSV (0-indexed):
# Name = Column B (index 1)
# Current Balance = Column J (index 9)
# Account Limit = Column N (index 13)
# Liability Interest Rate = Column O (index 14)
# Next Payment Due Date = Column R (index 17)
# Minimum Payment Amount = Column T (index 19)
COLUMN_MAPPING = {
    'card_name': 1,        # Column B - Name
    'balance': 9,          # Column J - Current Balance
    'credit_limit': 13,   # Column N - Account Limit
